...
- Use `Channel.fromSamplesheet()` from `nf-validation` to validate input sample sheets and create an input channel ([#54](https://github.com/nf-core/crisprseq/pull/54))
