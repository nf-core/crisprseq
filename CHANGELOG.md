...
## [v2.4.0 - Mustard Meitner](https://github.com/nf-core/crisprseq/releases/tag/2.4.0) - [03.03.2025]

### Added

- Add an acknowledgement to Hitselection method ([#222]https://github.com/nf-core/crisprseq/pull/222)
