...
workflow CRISPRSEQ_SCREENING {
    ...
    if (params.gpt_interpretation && params.gpt_interpretation.split(',').contains('drugz')) {
        if (params.drugz) {
            ...
            GPT_PREPARE_DRUGZ_QUERY.out.query
                .map { it ->
                    it.text
                }
                .collect()
            ...
            println 'You specified DrugZ for gpt interpretation, but DrugZ is not running.'
        }
    }
    if (params.gpt_interpretation && params.gpt_interpretation.split(',').contains('mle')) {
        if (params.mle) {
            ...
            GPT_PREPARE_MLE_QUERY.out.query
                .map { it ->
                    it.text
                }
                .collect()
            ...
            println 'You specified MAGeCK MLE for gpt interpretation, but MAGeCK MLE is not running.'
        }
    }
    if (params.gpt_interpretation && params.gpt_interpretation.split(',').contains('bagel2')) {
        if (params.bagel2) {
            ...
            GPT_PREPARE_BAGEL2_QUERY.out.query
                .map { it ->
                    it.text
                }
                .collect()
            ...
            println 'You specified BAGEL2 for gpt interpretation, but BAGEL2 is not running.'
        }
    }
    if (params.gpt_interpretation && params.gpt_interpretation.split(',').contains('rra')) {
        if (params.rra) {
            ...
            GPT_PREPARE_RRA_QUERY.out.query
                .map { it ->
                    it.text
                }
                .collect()
            ...
            println 'You specified MAGeCK RRA for gpt interpretation, but MAGeCK RRA is not running.'
        }
    }
